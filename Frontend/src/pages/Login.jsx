        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          <div className="logo-container" style={{ justifyContent: 'center', marginBottom: '16px', gap: '8px' }}>
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
              <rect x="3" y="5" width="18" height="15" rx="3" stroke="url(#logo-grad-login)" strokeWidth="2.2" />
              <path d="M8 2V5M16 2V5" stroke="url(#logo-grad-login)" strokeWidth="2.2" strokeLinecap="round" />
              <path d="M3 9H21" stroke="url(#logo-grad-login)" strokeWidth="2.2" />
              ...
              <defs>
                <linearGradient id="logo-grad-login" x1="3" y1="2" x2="21" y2="20" gradientUnits="userSpaceOnUse">
