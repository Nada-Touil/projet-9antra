            ...
            <div style={{ textAlign: 'center', marginBottom: '28px' }}>
              <div className="logo-container" style={{ justifyContent: 'center', marginBottom: '16px', gap: '8px' }}>
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
                  <rect x="2" y="4" width="16" height="12" rx="2.5" stroke="url(#logo-grad-reg)" strokeWidth="2.2" />
                  <line x1="5" y1="8" x2="11" y2="8" stroke="url(#logo-grad-reg)" strokeWidth="1.8" strokeLinecap="round" />
                  <line x1="5" y1="12" x2="9" y2="12" stroke="url(#logo-grad-reg)" strokeWidth="1.8" strokeLinecap="round" />
                  <path d="M13 11L21 15L17 17L15 21L13 11Z" fill="#7c3aed" stroke="#7c3aed" strokeWidth="1.5" strokeLinejoin="round" />
                  <defs>
                    <linearGradient id="logo-grad-reg" x1="2" y1="4" x2="18" y2="16" gradientUnits="userSpaceOnUse">
