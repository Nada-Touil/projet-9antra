    ...
    <header className="header glass">
      <div className="logo-container" onClick={() => navigate('/')} style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
          <path d="M5 15C5 10.5 8.5 7 12 7C15.5 7 19 10.5 19 15" stroke="url(#logo-grad-header)" strokeWidth="2.5" strokeLinecap="round" />
          <path d="M12 3V7" stroke="url(#logo-grad-header)" strokeWidth="2.5" strokeLinecap="round" />
          <path d="M10 3H14" stroke="url(#logo-grad-header)" strokeWidth="2" strokeLinecap="round" />
          <path d="M2 18H22" stroke="url(#logo-grad-header)" strokeWidth="2.5" strokeLinecap="round" />
          <rect x="5" y="15" width="14" height="3" rx="1.5" fill="url(#logo-grad-header)" />
          <defs>
            <linearGradient id="logo-grad-header" x1="2" y1="3" x2="22" y2="18" gradientUnits="userSpaceOnUse">
